(()=>{var t=typeof browser<"u"?browser:typeof chrome<"u"?chrome:null;if(!t)throw new Error("browser-polyfill: No extension API namespace found (neither browser nor chrome).");var n=typeof browser>"u"&&typeof chrome<"u";function r(e,s){return(...o)=>{try{let i=s.apply(e,o);if(i&&typeof i.then=="function")return i}catch{}return new Promise((i,c)=>{s.apply(e,[...o,(...u)=>{t.runtime&&t.runtime.lastError?c(new Error(t.runtime.lastError.message)):i(u.length<=1?u[0]:u)}])})}}var a={};a.runtime={sendMessage(...e){return n?r(t.runtime,t.runtime.sendMessage)(...e):t.runtime.sendMessage(...e)},onMessage:t.runtime.onMessage,getURL(e){return t.runtime.getURL(e)},openOptionsPage(){return n?r(t.runtime,t.runtime.openOptionsPage)():t.runtime.openOptionsPage()},get id(){return t.runtime.id}};a.storage={local:{get(...e){return n?r(t.storage.local,t.storage.local.get)(...e):t.storage.local.get(...e)},set(...e){return n?r(t.storage.local,t.storage.local.set)(...e):t.storage.local.set(...e)},clear(...e){return n?r(t.storage.local,t.storage.local.clear)(...e):t.storage.local.clear(...e)},remove(...e){return n?r(t.storage.local,t.storage.local.remove)(...e):t.storage.local.remove(...e)}},sync:t.storage?.sync?{get(...e){return n?r(t.storage.sync,t.storage.sync.get)(...e):t.storage.sync.get(...e)},set(...e){return n?r(t.storage.sync,t.storage.sync.set)(...e):t.storage.sync.set(...e)},remove(...e){return n?r(t.storage.sync,t.storage.sync.remove)(...e):t.storage.sync.remove(...e)},clear(...e){return n?r(t.storage.sync,t.storage.sync.clear)(...e):t.storage.sync.clear(...e)},getBytesInUse(...e){return t.storage.sync.getBytesInUse?n?r(t.storage.sync,t.storage.sync.getBytesInUse)(...e):t.storage.sync.getBytesInUse(...e):Promise.resolve(0)}}:null,onChanged:t.storage?.onChanged||null};a.tabs={create(...e){return n?r(t.tabs,t.tabs.create)(...e):t.tabs.create(...e)},query(...e){return n?r(t.tabs,t.tabs.query)(...e):t.tabs.query(...e)},remove(...e){return n?r(t.tabs,t.tabs.remove)(...e):t.tabs.remove(...e)},update(...e){return n?r(t.tabs,t.tabs.update)(...e):t.tabs.update(...e)},get(...e){return n?r(t.tabs,t.tabs.get)(...e):t.tabs.get(...e)},getCurrent(...e){return n?r(t.tabs,t.tabs.getCurrent)(...e):t.tabs.getCurrent(...e)},sendMessage(...e){return n?r(t.tabs,t.tabs.sendMessage)(...e):t.tabs.sendMessage(...e)}};a.alarms=t.alarms?{create(...e){let s=t.alarms.create(...e);return s&&typeof s.then=="function"?s:Promise.resolve()},clear(...e){return n?r(t.alarms,t.alarms.clear)(...e):t.alarms.clear(...e)},onAlarm:t.alarms.onAlarm}:null;async function f(){if(window===window.top)return!0;try{if(!(await a.storage.local.get({blockCrossOriginFrames:!0})).blockCrossOriginFrames)return!0}catch{return!1}try{return window.top.location.href,!0}catch{return!1}}f().then(e=>{if(!e)return;let s=document.createElement("script");s.setAttribute("src",a.runtime.getURL("nostr.build.js")),document.body.appendChild(s),document.addEventListener("visibilitychange",()=>{document.visibilityState==="visible"&&a.runtime.sendMessage({kind:"resetAutoLock"}).catch(()=>{})})});var d=null,m=null;function g(){if(d)return;let e=document.createElement("div");e.id="nostrkey-permission-sheet",e.innerHTML=`
    ...
    `,document.body.appendChild(e),d=e,e.querySelector("#nk-allow").addEventListener("click",()=>{y(!0)}),e.querySelector("#nk-deny").addEventListener("click",()=>{y(!1)}),e.querySelector(".nk-backdrop").addEventListener("click",()=>{y(!1)})}function y(e){if(!m)return;let s=d.querySelector("#nk-remember").checked;d.classList.remove("active"),d.querySelector("#nk-remember").checked=!1,m({allowed:e,remember:s}),m=null}function h(e){switch(e){case"getPubKey":return"Read your public key";case"signEvent":return"Sign an event";case"getRelays":return"Read your relay list";case"nip04.encrypt":return"Encrypt a message (NIP-04)";case"nip04.decrypt":return"Decrypt a message (NIP-04)";case"nip44.encrypt":return"Encrypt a message (NIP-44)";case"nip44.decrypt":return"Decrypt a message (NIP-44)";default:return e}}function v(e,s,o,i){g(),d.querySelector("#nk-host").textContent=e,d.querySelector("#nk-permission").textContent=h(s);let c=d.querySelector("#nk-queue");return c&&(c.textContent=i>1?`(${o} of ${i})`:""),d.classList.add("active"),new Promise(u=>{m=u})}var l=null,p=null;function x(){if(l&&l.classList.contains("active")){p&&clearTimeout(p),p=setTimeout(k,5e3);return}l&&l.remove();let e=document.createElement("div");e.id="nostrkey-locked-sheet",e.innerHTML=`
        <style>
    ...
    `,document.body.appendChild(e),l=e,requestAnimationFrame(()=>e.classList.add("active")),e.querySelector(".nk-btn").addEventListener("click",k),e.querySelector(".nk-backdrop").addEventListener("click",k),p=setTimeout(k,5e3)}function k(){if(p&&(clearTimeout(p),p=null),!l)return;l.classList.remove("active");let e=l;l=null,setTimeout(()=>e.remove(),300)}a.runtime.onMessage.addListener((e,s,o)=>{if(e.kind==="showPermissionSheet")return v(e.host,e.permissionKind,e.queuePosition,e.queueTotal).then(i=>{o(i)}),!0;if(e.kind==="showLockedSheet")return x(),o(!0),!0});window.addEventListener("message",async e=>{if(e.source!==window)return;let s=["getPubKey","signEvent","getRelays","addRelay","exportProfile","nip04.encrypt","nip04.decrypt","nip44.encrypt","nip44.decrypt","replaceURL","bunkerServer.start","bunkerServer.stop","bunkerServer.status"],{kind:o,reqId:i,payload:c}=e.data;if(s.includes(o)){try{c=await a.runtime.sendMessage({kind:o,payload:c,host:window.location.host})}catch(u){c={error:"connection_error",message:u.message||"Failed to reach extension background"}}o=`return_${o}`,window.postMessage({kind:o,reqId:i,payload:c},"*")}});})();
